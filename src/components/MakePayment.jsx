  ...
  const submit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://benedict.alwaysdata.net/api/mpesa_payment",
        data,
      );
      ...
      <div style={styles.card}>
        ...
        <form onSubmit={submit} style={{ marginTop: 8 }}>
          ...
          <button
            ...
            style={
              loading
                ? { ...styles.btnPay, ...styles.btnPayLoading }
                : styles.btnPay
            }
            onMouseEnter={(e) =>
...
const styles = {
  ...
  blob1: {
    ...
    height: 420,
    background:
      "radial-gradient(circle, rgba(0,230,118,0.18) 0%, transparent 70%)",
    borderRadius: "50%",
  ...
  divider: {
    height: 1,
    background:
      "linear-gradient(90deg, transparent, rgba(0,230,118,0.3), transparent)",
    margin: "24px 0",
  },
