...
const SigninPage = () => {
  ...
  useEffect(() => {
    ...
    if (remembered?.username) {
      // Only pre-fill username, not password for security
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://benedict.alwaysdata.net/api/signin",
        data,
      );
  ...
  return (
    <div className="d-flex flex-column min-vh-100 offer-bg">
      ...
      <div className="container flex-grow-1 d-flex justify-content-center align-items-start py-5">
        <div
          className="card p-5 shadow-lg offer-card"
